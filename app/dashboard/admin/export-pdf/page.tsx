  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex space-x-2 mb-5">
        <Button className="bg-red-500 opacity-90 hover:bg-red-600" size="sm">Export PDF</Button>
        <Button className="bg-green-500 opacity-90 hover:bg-green-600" size="sm">Export Excel</Button>
      </div>
